...
if (empty($_GET['key']) && empty($_POST['key'])) { ?>
    ...
    echo network_site_url('wp-activate.php'); ?>">
			<p>
			    <label for="key"><?php
...
?>
        ...
        if ($url != network_home_url('', 'http')): ?>
				<p class="view"><?php
            printf(__('Your account is now activated. <a href="%1$s">View your site</a> or <a href="%2$s">Log in</a>') , $url, $url . 'wp-login.php'); ?></p>
			<?php
        else: ?>
				<p class="view"><?php
